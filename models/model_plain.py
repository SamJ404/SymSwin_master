...
from models.loss_uwt import UWTLoss
...
class ModelPlain(ModelBase):
    ...
    def define_loss(self):
        ...
        if self.opt_train.get('Gaux_loss'):
            Gaux_loss = self.opt_train['Gaux_loss']
            if Gaux_loss == 'uwt':
                self.Gaux_loss = UWTLoss(train_weight= self.opt_train['Gaux_loss_weight']).to(self.device)
    ...
    def optimize_parameters(self, current_step):
        ...
        G_loss += self.Gaux_loss(self.E, self.H)
        G_loss.backward()
