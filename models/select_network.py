...
def define_G(opt):
    ...
    # ----------------------------------------
    if net_type == 'swinir':
        from models.SwinIR.SwinIR_arch  import SwinIR as net
        ...
        from models.DAT.dat_arch import DAT as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   split_size=[opt_net['window_size'],opt_net['window_size']],
                   img_range=opt_net['img_range'],
                   depth=opt_net['depths'],
                   embed_dim=opt_net['embed_dim'],
                   num_heads=opt_net['num_heads'],
                   expansion_factor=opt_net['mlp_ratio'],
                   upsampler=opt_net['upsampler'],
                   resi_connection=opt_net['resi_connection'])
        ...
        from models.HiT.hit_sir_arch import HiT_SIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   base_win_size=[opt_net['window_size'],opt_net['window_size']],
                   img_range=opt_net['img_range'],
                   depths=opt_net['depths'],
                   embed_dim=opt_net['embed_dim'],
                   num_heads=opt_net['num_heads'],
        ...
        from models.TTST.TTST_arch import TTST as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    elif net_type == 'SRFormer':
        from models.SRFormer.srformer_arch import SRFormer as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
    ...
    # Need to modified inside the network
    elif net_type == 'TransENet':
        from models.TransENet.transenet import TransENet as net
        netG = net()



    elif net_type == 'SymSwinLight':
        from models.SymSwinLight.SymSwinLight import SymSwinLight as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
